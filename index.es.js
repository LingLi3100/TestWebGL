import { Tools, Vector3, ArcRotateCameraMouseWheelInput, ArcRotateCamera, Texture, Color4, Scene, HemisphericLight, Layer, Color3, GlowLayer, SpotLight, DirectionalLight, PointLight, Animation, SceneLoader, MeshBuilder, Mesh, SerializationHelper, InspectableType, PBRMaterial, NodeMaterial, ExecuteCodeAction, ActionManager, TransformNode, CubicEase, SceneOptimizerOptions, HardwareScalingOptimization, SceneOptimizer, Engine } from 'babylonjs';
...
var MVCameraShot = /** @class */ (function () {
    ...
    MVCameraShot.prototype.updateSettings = function (camera) {
        ...
        camera.setPosition(new (Vector3.bind.apply(Vector3, __spreadArrays([void 0], this.settings.position)))());
        camera.setTarget(new (Vector3.bind.apply(Vector3, __spreadArrays([void 0], this.settings.target)))(), false, true);
...
var CameraService = /** @class */ (function () {
    ...
    CameraService.prototype.setupDefaultCamera = function () {
        var camera = new MVCamera('mainCamera', Math.PI / 2, Math.PI / 2, 2, Vector3.Zero(), this._scene);
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        if (texture) {
                            ...
                            texture = Texture.Parse(config, _this._scene, rootUrl);
...
var EnvironmentService = /** @class */ (function () {
    ...
    EnvironmentService.prototype.setupDefaultEnvironment = function () {
        ...
        new HemisphericLight('hemisphericLight', new Vector3(1, 1, 0), this._scene);
    };
    /**
    ...
    EnvironmentService.prototype.setBackgroundImage = function (textureUrl, texturesName) {
        ...
        return new Promise(function (resolve, reject) {
            var backdrop = new Layer('backdrop', textureUrl + texturesName, _this._scene);
                                ...
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (glowLayer) {
                                            ...
                                            glowLayer = new GlowLayer('glowLayer', this_1._scene);
                                            glowLayer.intensity = value;
                                        }
                                        return [3 /*break*/, 5];
                                    case 2:
                                    ...
                                    case 4:
                                        if (isString(value) || isNumber(value) || isBoolean(value)) {
                                            ...
                                            color = new Color3(value.r, value.g, value.b);
                                            this_1._scene[key] = color;
                                        }
    ...
    EnvironmentService.prototype.parseLights = function (lightJSON) {
        switch (lightJSON.type) {
            case 0:
                var pointLight = new PointLight(lightJSON.name, new Vector3(lightJSON.position[0], lightJSON.position[1], lightJSON.position[2]), this._scene);
                this.applyLightSettings(pointLight, lightJSON);
                break;
            case 1:
                var directionalLight = new DirectionalLight(lightJSON.name, new Vector3(lightJSON.direction[0], lightJSON.direction[1], lightJSON.direction[2]), this._scene);
                this.applyLightSettings(directionalLight, lightJSON);
                break;
            case 2:
                var spotLight = new SpotLight(lightJSON.name, new Vector3(lightJSON.position[0], lightJSON.position[1], lightJSON.position[2]), new Vector3(lightJSON.direction[0], lightJSON.direction[1], lightJSON.direction[2]), lightJSON.angle, lightJSON.exponent, this._scene);
                this.applyLightSettings(spotLight, lightJSON);
                break;
            case 3:
                var hemisphericLight = new HemisphericLight(lightJSON.name, new Vector3(lightJSON.direction[0], lightJSON.direction[1], lightJSON.direction[2]), this._scene);
        ...
        var _loop_2 = function (key, value) {
            if (key.toLowerCase() === 'direction') {
                ...
                if (isVector3Array(value))
                    light.setDirectionToTarget(new Vector3(value[0], value[1], value[2]));
            }
                ...
                value.map(function (animation) {
                    light[key].push(new Animation(animation.name, animation.targetProperty, animation.framePerSecond, animation.dataType, isNumber(animation.loopMode) ? animation.loopMode : null, isBoolean(animation.enableBlending) ? animation.enableBlending : null));
                });
            }
...
var AssetLoaderLocal = /** @class */ (function () {
    ...
    AssetLoaderLocal.prototype.loadMeshes = function (url, fileName) {
        return SceneLoader.LoadAssetContainerAsync(url, fileName, this._scene, null).then(function (assetContainer) {
...
var MeshService = /** @class */ (function () {
    ...
    MeshService.prototype.createPlane = function (name, size, position, billboardModeAll) {
        var planeMesh = MeshBuilder.CreatePlane(name, {
            size: size,
        }, this._scene);
        planeMesh.position = position;
        planeMesh.visibility = 1;
        planeMesh.billboardMode = billboardModeAll ? Mesh.BILLBOARDMODE_ALL : Mesh.BILLBOARDMODE_NONE;
        return planeMesh;
    };
    /**
    ...
    MeshService.prototype.createSphere = function (name, diameter, position, visible) {
        var sphere = MeshBuilder.CreateSphere(name, {
            diameter: diameter,
        }, this._scene);
...
var MVMaterial = /** @class */ (function (_super) {
    ...
    MVMaterial.prototype.parseMaterialFromConfig = function (name, id, materialConfig, scene, rootUrl) {
        ...
        var material = SerializationHelper.Parse(function () { return _this; }, materialConfig, scene, rootUrl);
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (materialConfig.customType == 'BABYLON.PBRMaterial') {
                            ...
                            nodeMaterial = NodeMaterial.Parse(materialConfig, this._scene, textureBaseUrl);
...
var ActionsService = /** @class */ (function () {
    ...
    ActionsService.prototype.registerClickEvent = function (mesh, callback) {
        ...
        mesh.actionManager.registerAction(new ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function (event) { return callback(); }));
    };
    /**
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 5:
                        ...
                        this._rootNode = new TransformNode('__root__', this._scene);
...
var ActionItem = /** @class */ (function () {
    ...
    function ActionItem(scene, options) {
        ...
        this._fadeAnimation = new Animation('fadeAnimation', 'visibility', 30, Animation.ANIMATIONTYPE_FLOAT, Animation.ANIMATIONLOOPMODE_CONSTANT);
                                ...
                                case 1:
                                    ...
                                    options_1 = __assign(__assign({}, optionsJSON), { actionItems: optionsJSON.actionItems.map(function (actionItemJSON) {
                                            return __assign(__assign({}, actionItemJSON), { states: actionItemJSON.states.map(function (stateJSON) {
                                                    return __assign(__assign({}, stateJSON), { position: new (Vector3.bind.apply(Vector3, __spreadArrays([void 0], stateJSON.position)))() });
...
var MVSceneOptimizer = /** @class */ (function () {
    ...
    function MVSceneOptimizer(scene, targetFps) {
        ...
        this._scene = scene;
        this._options = new SceneOptimizerOptions(targetFps);
    }
    /**
    ...
    MVSceneOptimizer.prototype.addHardwareScalingOptimization = function (priority, maxScale, steps) {
        ...
        this._options.addOptimization(new HardwareScalingOptimization(priority, maxScale, steps));
    };
    /**
    ...
    MVSceneOptimizer.prototype.init = function () {
        ...
        this._optimizer = new SceneOptimizer(this._scene, this._options, true, true);
...
var Core = /** @class */ (function () {
    ...
    Core.prototype.registerEventListeners = function () {
        ...
        var keyDownEvent = fromEvent(window, 'keydown');
        // Avoid multiple calls on resize
        var debouncedResizeEvent = resizeEvent.pipe(debounceTime(100), takeUntil(onDestroy$));
        ...
        keyDownEvent.pipe(takeUntil(onDestroy$)).subscribe(function (key) {
            switch (key.code) {
                case 'KeyI': {
...
export { ActionItemManager, CameraManager, Core, EngineTypes, EntityManager, EnvironmentManager, MeshManager };
